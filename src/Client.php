...
class Client
{
     ...
     *
     * @var array<string, Connection> $conn Open connections to Gearman servers
     */
     ...
     *
     * @var array<int, string> $servers A list of potential Gearman servers
     */
     ...
     * @see Task, Set
     */
    public function __call(string $func, array $args = array()): string
    {
        $send = "";
     ...
     *
     */
    public static function getInstance($servers, int $timeout = 1000): self {
