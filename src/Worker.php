...
class Worker
{
     ...
     *
     * @var array<string, Connection> $conn
     */
    protected array $conn = array();

    /**
     * Pool of retry connections
     *
     * @var array<string, array{server:string,retry_time:float,attempts:int}> $conn
     */
    protected array $retryConn = array();

    /**
     * List of servers that have failed a connection
     *
     * @var array<string, float> $conn
     */
    protected array $failedConn = array();
     ...
     *
     * @var array<string, array> $initParams
     */
    protected array $initParams = array();
     ...
     * @see Connection
     */
    public function __construct($servers, string $id = "", ?int $socket_timeout = null)
    {
     ...
     * @see $conn->send()
     */
    public function addAbility(string $ability, ?int $timeout = null, array $initParams = array(), ?Connection $conn = null): void
    {
        $call   = 'can_do';
     ...
     * @return void
     */
    protected function addAbilities(?Connection $conn = null): void
    {
     ...
     * @see Worker::doWork(), Worker::addAbility()
     */
     ...
     * @return void
     */
    protected function start(string $handle, string $job, $args): void
    {
